	...
	<ul>
		...
		<li class="leftmenu_dept01">
			...
			<ul>
				...
				<li class="dept02"><a href="javascript:fn_main_headPageAction('45','cop/bbs/selectBoardList.do?bbsId=BBSMSTR_DDDDDDDDDDDD')">임시게시판</a></li>
			</ul> 
		</li>
		<% } %>
		...
		<li class="leftmenu_dept01">
			...
			<ul>	
                ...
                <li class="dept02"><a href="javascript:fn_main_headPageAction('56','cop/bbs/selectBoardList.do?bbsId=BBSMSTR_BBBBBBBBBBBB')">사이트러리관리</a></li>
			</ul> 
		</li>
		<% } %>
	</ul>
